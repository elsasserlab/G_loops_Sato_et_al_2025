...
cov.WT <- bw_loci(BWs.WT, loci = enh_act)
cov.DHX36 <- bw_loci(BWs.DHX36, loci = enh_act)
cov.FANCJ <- bw_loci(BWs.FANCJ, loci = enh_act)
cov.DKO <- bw_loci(BWs.DKO, loci = enh_act)
...
write.table(results_table,"EnhAct_DESeq_results.txt", row.names = F, col.names = T,quote = F, sep = "\t")
```

```{r}
dir.create("./plots",showWarnings = F)
ggsave("plots/EnhAct_DESeq2_MA_DHX36.pdf",plot_MA_DHX36,width = 4, height= 4)
ggsave("plots/EnhAct_DESeq2_MA_FANCJ.pdf",plot_MA_FANCJ,width = 4, height= 4)
ggsave("plots/EnhAct_DESeq2_MA_DKO.pdf",plot_MA_DKO,width = 4, height= 4)
ggsave("plots/EnhAct_DESeq2_LFC_DHX36.pdf",plot_LFC_DKO_vs_DHX36,width = 4, height= 4)
ggsave("plots/EnhAct_DESeq2_LFC_FANCJ.pdf",plot_LFC_DKO_vs_FANCJ,width = 4, height= 4)
``` 
...
p
ggsave("panels/EnhAct_DESeq2.pdf",p)
``` 
